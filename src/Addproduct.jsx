...
function Addproduct() {
    ...
    const [paperback, changepaperback] = useState('');
        ...
        <>
            ...
            <div className="w-3/4 mx-auto my-5">
                ...
                <div className="relative z-0 w-full mb-6 group">
                    ...
                    }} value={price} name="price" className="block py-2.5 px-0 w-full text-sm text-black bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600  focus:outline-none focus:border-gray-300 focus:ring-0 peer" placeholder=" " required="" />
                ...
                <div className="flex flex-col w-full justify-center items-center">
                    ...
                    <button type="button" className="bg-white text-black w-24 rounded-lg border-0 px-3 py-2 my-2 mx-8" style={{ 'border': '1px solid black' }} onClick={async (e) => {
                        ...
                        axios.post('https://singh-publication.onrender.com/api/product/addproduct', {
                            title: title,
                            author: author,
                            publisher: publisher,
                            language: language,
