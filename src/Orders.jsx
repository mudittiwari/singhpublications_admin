...
function Orders() {
    ...
    async function getorders() {
        axios.get('http://localhost:5000/api/order/getallorders', {
            headers: {
        ...
        uploadTask.on('state_changed',
            (snapShot) => {
                ...
                getDownloadURL(uploadTask.snapshot.ref).then(async(downloadURL) => {
                    ...
                    await axios.put('http://localhost:5000/api/order/updateinvoice', {
                        "order_id": id,
            ...
            <ul>
                ...
                {ordersarray.map((value, index) => {
                    ...
                    return <div className=" bg-white h-max px-5 my-8 rounded-md py-5 mx-auto flex w-3/4 related">
                        ...
                        today = mm + '-' + dd + '-' + yyyy;
                        console.log(today);
                                            await axios.put('http://localhost:5000/api/order/updatedelivery', {
                                                "order_id": value.id,
